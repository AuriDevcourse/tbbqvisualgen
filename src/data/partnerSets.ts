 ...
 *  value, high to low. 211 partners across 12 tiers, generated from
...
export const ALL_PARTNER_TIERS: PartnerTierRoster[] = [
  {
    ...
    ladder: true,
    logos: [
      { label: "Beyond Beta", src: "/logos/Beyond%20Beta%20Building.svg" },
      { label: "Danish Life Science Cluster", src: "/logos/Danish%20Life%20Science%20Cluster%20White.svg" },
      { label: "Erhvervsfremmebestyrelsen", src: "/logos/Erhvervsfremmebestyrelsen.svg" },
      { label: "Nordea", src: "/logos/Nordea%20Startup%20%26%20Growth.svg" },
      { label: "Novo Nordisk Foundation", src: "/logos/Novo%20Nordisk%20Foundation%202.svg" },
    ],
  },
  {
    id: "main",
    ...
    ladder: true,
    logos: [
      { label: "Dealroom", src: "/logos/Dealroom.svg" },
      { label: "Google Cloud", src: "/logos/Google%20Cloud.svg" },
      { label: "Innovation District Copenhagen", src: "/logos/Innovation%20District%20Copenhagen%20White.png" },
      { label: "Life Science Invest", src: "/logos/Life%20Science%20Invest.svg" },
    ],
  },
  {
    ...
    ladder: true,
    logos: [
      { label: "EIFO (Export & Investment Fund of Denmark)", src: "/logos/EIFO%20(Export%20%26%20Investment%20Fund%20of%20Denmark).svg" },
      { label: "Innovation Centre Denmark", src: "/logos/ICDK.svg" },
      { label: "Nebius", src: "/logos/Nebius.svg" },
      { label: "NORNORM", src: "/logos/Nornorm%20White.svg" },
      { label: "Owl Ventures", src: "/logos/Owl%20Ventures.svg" },
      { label: "Southern Sweden", src: "/logos/Southern%20Sweden.svg" },
    ],
  },
  {
    id: "pioneer",
    ...
    ladder: true,
    logos: [
      { label: "Boardway", src: "/logos/Boardway.svg" },
      { label: "Copenhagen", src: "/logos/City.svg" },
      { label: "DPIIT", src: "/logos/DPIIT.svg" },
      { label: "Erhvervshus Sjælland", src: "/logos/Erhvervshus%20Sj%C3%A6lland%20White.svg" },
      { label: "Jyske Bank Growth", src: "/logos/Jyske%20Bank%20Growth.svg" },
      { label: "rebriQ", src: "/logos/rebriQ.svg" },
      { label: "Women in Tech Denmark", src: "/logos/Women%20in%20Tech.svg" },
    ],
  },
  {
    id: "core",
    ...
    ladder: true,
    logos: [
      { label: "BSI", src: "/logos/BSI.svg" },
      { label: "Business Iceland", src: "/logos/Business%20Iceland.svg" },
      { label: "Crispa Technologies ApS", src: "/logos/Crispa.svg" },
      { label: "Danish Entrepreneurs", src: "/logos/Danish%20Entrepreneurs.svg" },
      { label: "Embassy of the Netherlands", src: "/logos/NL%20Netherlands.svg" },
      { label: "European Commission", src: "/logos/InvestEU.svg" },
      { label: "Flatpay", src: "/logos/Flatpay.svg" },
      { label: "Impact Fund Denmark", src: "/logos/Impact%20Fund%20Denmark%20White.svg" },
      { label: "Skytek Nordics ApS", src: "/logos/SKYtek.svg" },
      { label: "Symbion", src: "/logos/Symbion.svg" },
      { label: "TechSavvy", src: "/logos/Techsavvy.svg" },
    ],
  },
  {
    ...
    logos: [
      { label: "Antler", src: "/logos/Antler%20White.svg" },
      { label: "AstraZeneca", src: "/logos/AstraZeneca%20White.svg" },
      { label: "BETA.HEALTH", src: "/logos/Beta%20Heath.svg" },
      { label: "Breeze IP", src: "/logos/Breeze%20IP.svg" },
      { label: "Cloudflare", src: "/logos/Cloudflare.svg" },
      { label: "cse advisory, OMR Reviews", src: "/logos/CSE%20Advisory.svg" },
      { label: "DanBAN - Danish Business Angels", src: "/logos/DanBAN%20Danish%20Business%20Angels.svg" },
      { label: "Danish Business Authority", src: "/logos/Danish%20Business%20Authority%202.svg" },
      { label: "e-conomic", src: "/logos/e-conomic%20White.svg" },
      { label: "FBV - Association of Listed Danish Companies", src: "/logos/FBV%20EN%20Inverted.svg" },
      { label: "Finaman.io", src: "/logos/Finaman%20AI.svg" },
      { label: "Grant Thornton Denmark", src: "/logos/Grant%20Thornton.svg" },
      { label: "Humandone", src: "/logos/Humandone.svg" },
      { label: "N.Rich", src: "/logos/N.Rich.svg" },
      { label: "Plug and Play", src: "/logos/Plug%20and%20Play.svg" },
      { label: "PROSA", src: "/logos/Prosa.svg" },
      { label: "PSV", src: "/logos/PSV.svg" },
      { label: "Skiftr ApS", src: "/logos/Skiftr%20White.svg" },
      { label: "Spintop Ventures", src: "/logos/Spintop%20Ventures.svg" },
      { label: "Third Law ApS", src: "/logos/Third%20Law%20White.svg" },
      { label: "Vanta", src: "/logos/VANTA.svg" },
      { label: "Vend Marketplaces", src: "/logos/Vend.svg" },
      { label: "Vibrant", src: "/logos/Vibrant.svg" },
      { label: "Adeo Web", src: "/logos/Adeo%20Web.svg" },
    ],
  },
  {
    id: "community",
    ...
    logos: [
      { label: "AceON Accelerator", src: "/logos/Aceon.svg" },
      { label: "advores Advokater & Rechtanwälte PartGmbB", src: "/logos/Advores.svg" },
      { label: "AI Oresund", src: "/logos/AI%20Oresund.svg" },
      { label: "AIESEC in Denmark", src: "/logos/Aiesec%20White.svg" },
      { label: "AISTART Incubator - Business Helsinki", src: "/logos/AIStart%20Incubator.svg" },
      { label: "Arctic Startup", src: "/logos/ArcticStartup%20Mark.svg" },
      { label: "Auxxo Management GmbH", src: "/logos/AUXXO%20Female%20Catalyst%20Fund.svg" },
      { label: "BioMedical Design", src: "/logos/BioMedical%20Design.svg" },
      { label: "Brotherhood for Professionals of Color (BPoC)", src: "/logos/BPOC.svg" },
      { label: "Business Turku", src: "/logos/Businessturku.svg" },
      { label: "Career Club DK", src: "/logos/Carerclubdk.svg" },
      { label: "Clarma Capital", src: "/logos/Clarmacapital.png" },
      { label: "Clean", src: "/logos/Clean%20Cluster.svg" },
      { label: "Copenhagen Institute for Futures Studies", src: "/logos/Copenhagen%20Institute%20for%20Futures%20Studies.svg" },
      { label: "Copenhagen School of Entrepreneurship", src: "/logos/CBS%20CSE%20White.svg" },
      { label: "Creative Girls Club", src: "/logos/Creative%20Girls%20Club.svg" },
      { label: "Crescita Partners", src: "/logos/Crescita%20Partners.svg" },
      { label: "Czech Founders z.ú.", src: "/logos/CZech%20Founders.svg" },
      { label: "Danish Startup Group", src: "/logos/Danish%20Startup%20Group.svg" },
      { label: "Daya Ventures", src: "/logos/Daya%20Ventures.svg" },
      { label: "DI", src: "/logos/Dansk%20Industri.svg" },
      { label: "DTU Science Park", src: "/logos/DTU%20Science%20Park.svg" },
      { label: "Durana Tech Park", src: "/logos/Durana%20Tech%20Park.svg" },
      { label: "EIT Urban Mobility", src: "/logos/EIT%20Urban%20Mobility%20White.svg" },
      { label: "Embassy of India", src: "/logos/Embassy%20of%20India.svg" },
      { label: "European Space Agency Business Incubation Centre Denmark", src: "/logos/ESA%20Business%20Incubation%20Centre%20Denmark.svg" },
      { label: "Even Founders", src: "/logos/Even%20Founders%20White.svg" },
      { label: "FailForward by ForwardThinks", src: "/logos/FailForward%20by%20ForwardThinks.svg" },
      { label: "Femtech Studios", src: "/logos/Femtechstudios.svg" },
      { label: "Foras Ventures", src: "/logos/Foras%20Ventures.svg" },
      { label: "Founders Running Club", src: "/logos/Founders%20Running%20Club%20White.svg" },
      { label: "French Tech Copenhagen", src: "/logos/French%20Tech%20Copenhagen.svg" },
      { label: "Futuro Perfecto Innovation", src: "/logos/Futuro%20Perfecto%20Innovation.svg" },
      { label: "Global Startup Awards (XO Group ApS)", src: "/logos/Global%20Startup%20Awards%20(XO%20Group%20ApS).svg" },
      { label: "Global Stratalogues", src: "/logos/Global%20Stratalogues.svg" },
      { label: "Gothenburg Tech Week", src: "/logos/Gothenburg%20Tech%20Week.svg" },
      { label: "Greeks in the Nordics", src: "/logos/Greeks%20in%20the%20Nordics.svg" },
      { label: "HackYourFuture Denmark", src: "/logos/Hackyourfuture.svg" },
      { label: "Health Tech Hub Copenhagen", src: "/logos/Health%20Tech%20Hub%20Copenhagen.svg" },
      { label: "Humble AI Limited", src: "/logos/Humble%20AI%20White.svg" },
      { label: "IDA", src: "/logos/IDA%20White.svg" },
      { label: "Ignite Sweden", src: "/logos/Ignite%20Powered%20by%20SISP.svg" },
      { label: "imec vzw", src: "/logos/Imec%20White.svg" },
      { label: "Improve Business", src: "/logos/Improve%20Business.svg" },
      { label: "INCUBA x KITCHEN", src: "/logos/INCUBA%20x%20KITCHEN.svg" },
      { label: "Indian Venture & Alternate Capital Association", src: "/logos/IVCA.svg" },
      { label: "Innovation Skåne", src: "/logos/Innovation%20Sk%C3%A5ne.svg" },
      { label: "INNOVX BUSINESS ACCELERATOR S.R.L.", src: "/logos/Innovx.svg" },
      { label: "International Workplace Group", src: "/logos/IWG%20International%20Workplace%20Group.svg" },
      { label: "Kalvebod Fælled Skole", src: "/logos/Kalvebod%20Skole.svg" },
      { label: "KLAK - Icelandic Startups", src: "/logos/KLAK%20Icelandic%20Startups.svg" },
      { label: "Knowledgeboard", src: "/logos/Knowledgeboard.svg" },
      { label: "Kveikja", src: "/logos/Kveikja.svg" },
      { label: "LITHUANIABIO", src: "/logos/Lithuania%20Bio.svg" },
      { label: "Lithuanian Professionals in Copenhagen", src: "/logos/Lithuanian%20Professionals%20in%20Copenhagen.svg" },
      { label: "Lithuanian Youth Society In Denmark", src: "/logos/Lithuanian%20Youth%20Society%20In%20Denmark.svg" },
      { label: "MADE", src: "/logos/Futuremanufacturers.svg" },
      { label: "Medicon Valleyh Alliance", src: "/logos/Medicon%20Valley%20Alliance.svg" },
      { label: "Medicon Village", src: "/logos/Medicon%20Village.svg" },
      { label: "Mentorspace Lithuania, VšĮ", src: "/logos/Mentorspace%20Lithuania%2C%20V%C5%A1%C4%AE.svg" },
      { label: "Mesh", src: "/logos/Mesh%20Matrikel1%20White.svg" },
      { label: "Nordic Blockchain Association", src: "/logos/Nordic%20Blockchain%20Association.svg" },
      { label: "Nordic Music Tech", src: "/logos/Nordic%20Music%20Tech.svg" },
      { label: "Nordic Women's Health Hub", src: "/logos/Nordic%20Women's%20Health%20Hub.svg" },
      { label: "Norway Health Tech", src: "/logos/Norway%20Health%20Tech.svg" },
      { label: "Nova Talent", src: "/logos/Nova%20Talent.svg" },
      { label: "Odense Robotics", src: "/logos/Odense%20Robotics%20White.svg" },
      { label: "Professional Women of Colour Network (ProWoc)", src: "/logos/Professional%20Women%20of%20Colour%20Network%20(ProWoc).svg" },
      { label: "PropTech Denmark", src: "/logos/PropTech%20Denmark%20White.svg" },
      { label: "ProWoc - Professional Women of Colour", src: "/logos/ProWoc%20-%20Professional%20Women%20of%20Colour.svg" },
      { label: "PWN Copenhagen", src: "/logos/PWN%20Copenhagen.svg" },
      { label: "Radia Network", src: "/logos/Radia%20Network.svg" },
      { label: "REBBLS", src: "/logos/REBBLS.svg" },
      { label: "ReDI School of Digital Integration", src: "/logos/ReDI%20School%20of%20Digital%20Integration.svg" },
      { label: "Royal Danish Academy", src: "/logos/Royal%20Danish%20Academy.svg" },
      { label: "SDU Startup Station", src: "/logos/SDU%20Startup%20Station.svg" },
      { label: "Shine", src: "/logos/IVN%20Powered%20by%20Shine.svg" },
      { label: "SISP Swedish Incubators & Science Parks", src: "/logos/Swedish%20Incubators%20and%20Science%20Parks.svg" },
      { label: "SPACES/REGUS", src: "/logos/Spaces%20Regus%20White.svg" },
      { label: "Sri Sathya Sai Institute of Higher Learning", src: "/logos/Sri%20Sathya.svg" },
      { label: "START Paris", src: "/logos/START%20Paris%20White.svg" },
      { label: "STHLM Music City", src: "/logos/STHLM%20Music%20City.svg" },
      { label: "Talent Garden Denmark", src: "/logos/Talent%20Garden%20White.svg" },
      { label: "TechStation", src: "/logos/Techstation.svg" },
      { label: "Teknologisk Institut (Humanoide robotter)", src: "/logos/Teknologisk%20Institut.svg" },
      { label: "Terkko Health Hub", src: "/logos/Terkko%20Health%20Hub.svg" },
      { label: "The Energy Consortium, IIT Madras", src: "/logos/The%20Energy%20Consortium%2C%20IIT%20Madras.svg" },
      { label: "The Residency Vienna", src: "/logos/The%20Residency%20Vienna.svg" },
      { label: "THINGS (The Innovation Growhouse Stockholm AB)", src: "/logos/Things.svg" },
      { label: "TÜV SÜD Denmark Medical Health Services", src: "/logos/Tuvsud.svg" },
      { label: "UbuntuBiz", src: "/logos/Ubuntubiz.svg" },
      { label: "Venture Café Warsaw Foundation", src: "/logos/Venture%20Cafe%20Warsaw%20Horiz%20White.svg" },
      { label: "Voice AI SPace", src: "/logos/Voice%20AI%20Space.svg" },
      { label: "Wave by Vento", src: "/logos/Wave%20by%20Vento.svg" },
      { label: "Women in Data Science AI and ML", src: "/logos/Women%20in%20Data%20Science.svg" },
      { label: "Women in Tech Sweden", src: "/logos/WOMENINTECHSW.svg" },
      { label: "WomenTech Network", src: "/logos/Womentechnetwork.svg" },
      { label: "Young AI Leaders Linz", src: "/logos/Young%20AI%20Leaders%20Community%20Linz%20Hub.svg" },
      { label: "ZOKU Copenhagen", src: "/logos/Zoku.svg" },
    ],
  },
  {
    ...
    logos: [
      ...
      { label: "Embankment", src: "/logos/Embankment.svg" },
      { label: "European Investment Fund", src: "/logos/European%20Investment%20Fund%20(EIF).svg" },
      { label: "EY Danmark", src: "/logos/EY%20Danmark.svg" },
      { label: "Heartcore Capital", src: "/logos/Heartcore.svg" },
      { label: "HSBC Innovation Banking", src: "/logos/HSBC%20Innovation%20Banking.png" },
      { label: "Mazanti-Andersen", src: "/logos/Mazanti-Andersen.svg" },
      { label: "Rockstart", src: "/logos/Rockstart.svg" },
      { label: "WEZEO", src: "/logos/Wezeo.svg" },
  ...
  },
  {
    ...
    ladder: false,
    logos: [
      { label: "Business region Gothenburg AKA Gothenburg", src: "/logos/Business%20Region%20G%C3%B6teborg.svg" },
      { label: "Copenhagen Fintech Lab", src: "/logos/CPH%20Fintech%20White.svg" },
      { label: "Copenhagen School of Entrepreneurship", src: "/logos/CBS%20CSE%20White.svg" },
      { label: "GetAccept AB", src: "/logos/Getaccept.svg" },
      { label: "Highbridge Law Firm", src: "/logos/High%20Bridge.svg" },
      { label: "Legora AB", src: "/logos/Legora%20AB.svg" },
      { label: "Microsoft Danmark", src: "/logos/Microsoft%20White.svg" },
    ],
  },
  {
    id: "international",
    ...
    ladder: false,
    logos: [
      { label: "eryk", src: "/logos/eryk%20White.svg" },
      { label: "European Innovation Council", src: "/logos/European%20Innovation%20Council.svg" },
      { label: "swisstech", src: "/logos/Swisstech.svg" },
      { label: "TONIK", src: "/logos/Tonik%20White.svg" },
    ],
  },
  {
    id: "academic",
  ...
  },
  {
    ...
    logos: [
      { label: "Amela", src: "/logos/Amela.svg" },
      { label: "Bio Innovation Institue", src: "/logos/BioInnovation%20Institute.svg" },
      { label: "Bobbie & Beastie", src: "/logos/Bobbie%20%26%20Beastie.svg" },
      { label: "Brighteye Ventures", src: "/logos/Brighteye%20Ventures.svg" },
      { label: "Carta", src: "/logos/Carta%20White.svg" },
      { label: "Cherry Ventures", src: "/logos/Cherry%20Ventures.svg" },
      { label: "Cludo", src: "/logos/Cludo.svg" },
      { label: "Copenhagen Climate Week", src: "/logos/Copenhagen%20Climate%20Week.svg" },
      { label: "Danske Bank", src: "/logos/Danske%20Bank.svg" },
      { label: "Deloitte", src: "/logos/Deloitte.svg" },
      { label: "DTU Entrepreneurship", src: "/logos/DTU%20Entrepreneurship.svg" },
      { label: "EIFO", src: "/logos/EIFO.svg" },
      { label: "EU:CO", src: "/logos/EUCO.svg" },
      { label: "Florent VC", src: "/logos/Florent%20Venture%20Partners.svg" },
      { label: "Futuro Perfecto / Horizon Deep Tech Summit", src: "/logos/Horizon%20Deep%20Tech%20Summit.svg" },
      { label: "Indian Chamber of Commerce", src: "/logos/Indian%20Danish%20Chamber%20of%20Commerce.svg" },
      { label: "Industriens Fond", src: "/logos/Industriens%20Fond%20Colour.png" },
      { label: "Knowsilo Inc.", src: "/logos/Knowsilo%20Inc.svg" },
      { label: "Københavns university", src: "/logos/University%20of%20Copenhagen.svg" },
      { label: "Nordic Ninja", src: "/logos/NordicNinja.svg" },
      { label: "NORNORM", src: "/logos/Nornorm%20White.svg" },
      { label: "NVIDIA", src: "/logos/NVIDIA.svg" },
      { label: "Redalpine", src: "/logos/Redalpine.svg" },
      { label: "Rukam", src: "/logos/Rukam%20Capital.svg" },
      { label: "​​San Francisco Oy", src: "/logos/San%20Francisco.svg" },
      { label: "Seed Capital", src: "/logos/Seed%20Capital.svg" },
      { label: "Shift 4 Good", src: "/logos/Shift4Good.svg" },
      { label: "Space Denmark", src: "/logos/Space%20Denmark.svg" },
      { label: "Superseed", src: "/logos/Superseed.svg" },
      { label: "Sustainary", src: "/logos/Sustainary%20White.svg" },
      { label: "Tech Arena", src: "/logos/Tech%20Arena%20Sweden.svg" },
      { label: "The Kitchen (Aarhus University Startup Hub)", src: "/logos/The%20Kitchen.svg" },
      { label: "TiE Bangalore (NISS)", src: "/logos/Tie%20Bangalore.svg" },
    ],
  },
];
...
export const ALL_PARTNERS_UNRESOLVED: { label: string; tier: string; why: string }[] = [
  { label: "AWS Startups", tier: "Main", why: "only unusable files (application/postscript, application/postscript, application/postscript)" },
  { label: "Creative Business Network", tier: "Core", why: "raster only (CBN Logo white_CBN logo black (1).png) — needs a vector before it can go on a wall" },
  { label: "SHE/THEY Club", tier: "Core", why: "the SVG is a sheet export with an opaque background rectangle — needs a transparent cut" },
];
// ── end generated block ─────────────────────────────────────────────────

/** Logos per wall for a tier that outgrows one image. Community runs to 99 on
 *  its own, so the pages are explicit rather than a hidden truncation — the same
 *  call `COMMUNITY_PER_WALL` makes, at the same size, for the same reason: 30 is
 *  a grid these logos still read in. */
export const TIER_PER_WALL = 30;
...
export const ALL_PARTNER_WALLS: { tier: string; id: string; page: number; of: number; logos: PartnerSetEntry[] }[] =
  ALL_PARTNER_TIERS.flatMap((t) => {
    ...
    return Array.from({ length: pages }, (_, i) => ({
      ...
      page: i + 1,
      of: pages,
      logos: t.logos.slice(i * TIER_PER_WALL, (i + 1) * TIER_PER_WALL),
    }));
  });
 ...
 *  drawn 4 across has cells 1.5x the width of one drawn 6 across. The auto rule
 *  (roughly sqrt(3n), cells being wider than tall) gives each tier a squarish
 *  block of its own size, and the ladder tiers then take the widest column count
 *  seen so far, so Prime can never end up smaller than Community. */
export const ALL_PARTNERS_TIER_BANDS: { label: string; count: number; cols: number }[] = (() => {
  ...
  for (const t of ALL_PARTNER_TIERS) {
    ...
    const auto = Math.ceil(Math.sqrt(fresh.length * 3));
    // Never more columns than the band has logos — a one-partner tier is one
    // cell, not a half-empty row of two.
    const cols = Math.min(fresh.length, t.ladder ? Math.max(ladderCols, auto) : auto);
...
export const PARTNER_SETS: PartnerSet[] = [
  ...
  // outgrows one image. The headline stays the generic thank-you on every one of
  // them — Prime and Conqueror are what the DEAL is called internally, not
  // something to print on a slide, so the tier lives on the BUTTON and the wall
  // says "our partners". Type over it when a wall wants to name its group.
