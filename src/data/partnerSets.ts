 ...
 *  value, high to low. 129 partners across 7 tiers, generated from
...
export const ALL_PARTNER_TIERS: PartnerTierRoster[] = [
  ...
  },
  {
    ...
    ladder: true,
    logos: [
      { label: "AWS Startups", src: "/logos/Partners%202026/AWS%20Startups.svg" },
  ...
  },
  {
    ...
    logos: [
      ...
      { label: "Go Globie", src: "/logos/Partners%202026/Go%20Globie.svg" },
      ...
      { label: "Legora", src: "/logos/Partners%202026/Legora.svg" },
  ...
  },
  {
    ...
    logos: [
      ...
      { label: "MinnieMe", src: "/logos/Partners%202026/MinnieMe.svg" },
...
export const PARTNER_SETS: PartnerSet[] = [
  ...
  // The community thank-you wall: every Community-band partner who PAYS or has
  // a BARTER deal, straight from the tier roster. Auri, 2026-08-20: "All the
  // community partners that pay or have barter deal should be on Thank you to
  // our community partners."
  //
  // This used to be `COMMUNITY_PAGES` — the frozen 85-name list the published
  // posts were built from, split across three walls of 30. Two "Community"
  // entries that disagreed about who counts was the actual problem: clicking
  // the wrong one exported a wall with non-paying partners on it. The archive
  // array is still in this file (see `COMMUNITY_PARTNERS`) for rebuilding an
  // old post by hand, but it is no longer a button.
  //
  // 30 fits one wall, so there are no pages to worry about. If the set outgrows
  // THANKS_MAX_LOGOS, split it the way the Challenger tier is split rather than
  // silently truncating.
  {
    id: "community-paying",
    name: "Community",
    ...
    featuredCount: 0,
    logos: ALL_PARTNER_TIERS.find((t) => t.tier === "Community")?.logos ?? [],
  },
...
export const PARTNER_PROJECTS: PartnerProject[] = [
  ...
  },
  {
    ...
    note: "paying and barter partners",
    sets: [setById("community-paying")],
  },
];
